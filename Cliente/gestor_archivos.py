...
# Ejemplo de uso
carpeta_base = "resources"  # Cambia esta ruta si es necesario
archivo_salida = "./resources/catalog.json"
...
# Monitorear la carpeta cada 2 segundos
#gestor.monitorizar_carpeta(2)

# Verificar si un archivo está en 'uploadable_files'
nombre_archivo = "block_0001"
resultado = gestor.verificar_archivo_en_uploadable_files(nombre_archivo)
print(resultado)
